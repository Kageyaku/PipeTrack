...
export default function TrackScreen() {
  ...
  const API_URL = 'http://192.168.254.115/liwad-api';
  ...
  const logImageDetails = (ticket: Report) => {
    ...
    const fullImageUrl = `http://192.168.254.115/liwad-api/uploads/${ticket.image_path}`;
                    ...
                    injectedJavaScript={`
                      ...
                      window.postMessage(JSON.stringify({
                        ...
                        image: "${selectedTicket.image_path 
                          ? `http://192.168.254.115/liwad-api/uploads/${selectedTicket.image_path.replace(/^uploads\//, '')}` 
                          : ''}",
                        popupOptions: {
